...
export default function TourBook() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 p-6 container mx-auto">
      {/* Jodi route a /booking/ultapalta id dei tahole oi tour ke find korte parbena and error diba. So isError jodi hoi, tahole sei error ke handle korteci. error message UI te show kore */}
      {!isLoading && isError && (
        <div>
      ...
      {/* data jodi na pai tahole error ke handle korteci UI te akta message show kore */}
